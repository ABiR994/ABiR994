...
🎓 CSE student at AIUB  
🤖 Building AI-assisted projects using **OpenCode & Antigravity**  
💡 Believe in **learning by doing** and turning ideas into real, functional applications  
🛠️ Exploring web development, systems, and small, meaningful projects  
...
- **AI & Automation**: OpenCode, Antigravity Agents, AI-assisted development  
- **Systems**: Linux / Command Line / Bash Scripting  
- **Tools**: Git & GitHub, VS Code, Framer, Figma, Canva, Netlify, Vercel  
- **Concepts**: OOP, File I/O, Data Structures, Problem Solving, Web Security  

---

## 🌱 Currently Learning

- Advanced **Data Structures & Algorithms (DSA)** and **Databases**  
- End-to-end project development: **design → AI-assisted coding → deployment → version control**  
...
> *“Learning by doing, building with AI, and iterating fast” — every line of code is a step forward.* 💻
